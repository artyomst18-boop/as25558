...
fetch("/submission.json", { cache: "no-store" }).then(response => {
  ...
  document.querySelector("#review-alerts").innerHTML = `<article class="review-alert"><strong>Agent difference</strong><span>The certified inventory balance is €112,000; the €9,000 physical-count conflict remains disclosed.</span></article><article class="review-alert"><strong>Insurance correction</strong><span>€4,000 is expensed from the €12,000 opening prepaid balance; €8,000 remains prepaid.</span></article><article class="review-alert"><strong>Valuation caution</strong><span>Corrected net profit is €61,000, not management's €312,000 claim.</span></article>`;
